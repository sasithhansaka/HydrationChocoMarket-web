...
if(isset($_POST['submit'])){
    ...
    $sql="SELECT quantity,name,price FROM feastables WHERE id='$id'";
    ...
    if($items<=$quantity){
            ...
            if($result1==true){
                $update="UPDATE feastables SET quantity=quantity-$items WHERE  id='$id'";
...
<?php 
    include 'conf.php';
    $sql = "SELECT * FROM feastables WHERE id='$id' ";
    $result = mysqli_query($conn, $sql);
?>
...
?>
    ...
    <div class="obj">
       <div class="old">
        ...
        <form action="feastblesstore.php" method="POST"> 
