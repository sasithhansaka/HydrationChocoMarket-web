...
if(isset($_POST['submit'])){
    ...
    $sql="SELECT quantity,name,price FROM drinks WHERE id='$id'";
    ...
    if($items<=$quantity){
            ...
            if($result1==true){
                $update="UPDATE drinks SET quantity=quantity-$items WHERE  id='$id'";
...
?>
    ...
    <div class="obj">
       <div class="old">
        ...
        <form action="drinksstore.php" method="POST"> 
        ...
        if($qnt>0){
         ?>
          <input type="text" name="firstname" placeholder="firstname"required > <br>
        <input type="password" name="password" required placeholder="password"><br>
        <input type="number" name="items" min="1" value="1" max="<?php echo $qnt; ?>"required > <br>
